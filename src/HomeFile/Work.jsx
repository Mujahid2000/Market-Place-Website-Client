...
const Work = () => {
    return (
        <div className='px-5'>
            <Card className="max-w-[1800px] mx-auto mb-5 ">
      <h5 className="mb-2 text-3xl font-bold text-center text-gray-900 dark:text-white">Work fast from anywhere</h5>
      <p className="mb-5 text-base text-center text-gray-500 dark:text-gray-400 sm:text-lg">
        Stay up to date and move work forward with Taskla on iOS & Android. Download the app today.
      </p>
