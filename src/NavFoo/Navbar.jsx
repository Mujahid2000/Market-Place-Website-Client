...
const NavBar = () => {
    ...
    return (
        ...
        <Navbar.Brand href="">
            <img src="https://i.ibb.co/6nTm7CG/logo-m.png" className="mr-3 h-6 sm:h-9" alt="Taskla" />
            <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Taskla</span>
        </Navbar.Brand>
